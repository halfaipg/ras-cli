...
const USER_GEMINI_DIR = path.join(os.homedir(), '.ras');
// Project-level .gemini directory in the workspace
const WORKSPACE_GEMINI_DIR = path.join(projectRoot, '.ras');

// Telemetry artifacts are stored in a hashed directory under the user's ~/.ras/tmp
